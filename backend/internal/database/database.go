...
func New(cfg *config.Config, logger *zerolog.Logger, loggerSerice *loggerConfig.LoggerService) (*Database, error) {
	...
	if loggerSerice != nil && loggerSerice.GetApplication() != nil {
