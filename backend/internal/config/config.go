...
type Primary struct {
	Env string `koanf:"env" vaidate:"required"`
}
...
type IntegrationConfig struct {
	ResendAPIKey string `koanf:"resent_api_key" validate:"required"`
}
...
func LoadConfig() (*Config, error) {
	...
	// Set deault ObservabilityConfig if not provided
	if mainConfig.Observability == nil {
		mainConfig.Observability = DefaultObservabilityConfig()
	}

	// Override service name and evironment from primary config
